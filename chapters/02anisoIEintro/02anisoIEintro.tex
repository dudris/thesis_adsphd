...
\begin{figure}
	\centering
	\begin{tikzpicture}
		\draw (0,0) node [below left, inner sep =1cm] {\includegraphics[width=0.55\textwidth]{Winand1992_diagram.png}};
		\draw (0,0) node [below right, inner sep =1cm] {\includegraphics[width=0.7\textwidth]{Anders2009_SZM_.png}};
	\end{tikzpicture}
