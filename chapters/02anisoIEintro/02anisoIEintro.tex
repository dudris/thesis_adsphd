...
The interface velocity due to capillary forces alone $v_\sigma$ is proportional to the chemical potential and the interface mobility $M$ ~\cite{Trautt2005, Du2007, Abdeljawad2018}
\begin{equation}
	v_\sigma = M\mu_{surf} \,.
\end{equation}
This is the way the capillary driving force moves the surface. As a result, the interface stiﬀness is the key material property that relates interface curvature to interface thermodynamics and kinetics.~\cite{Du2007}
