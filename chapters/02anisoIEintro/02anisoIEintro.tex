...
\begin{figure}
	\centering
	\begin{tikzpicture}
		\draw (0,0) node [below left, inner sep =1cm] {\includegraphics[width=0.45\textwidth]{Winand1992_diagram.png}};
		\draw (0,0) node [below right, inner sep =1cm] {\includegraphics[width=0.45\textwidth]{Anders2009_SZM_.png}};
	\end{tikzpicture}
	\caption{Simplified empirical diagrams, in a) for electrodeposition~\cite{Winand1992}, in b) for high-energy deposition from vapor~\cite{Ande}.}
