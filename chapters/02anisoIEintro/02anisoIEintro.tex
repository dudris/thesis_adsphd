...
\begin{figure}
	\centering
	\includegraphics[page=1,width=0.5\textwidth]{sketches_intro.pdf}
	\caption{Illustration of the Winterbottom construction. The symbols $\sigma_1, \sigma_2(\theta), \sigma_3$ denote the interface energiees of the respectife interfaces, $\sigma_0$ is the scaling interface energy.  $\alpha_1$ is the orientation of the substrate, $\alpha_2$ of the substrate.}
