...
\begin{figure}
	\centering
	\begin{tikzpicture}
		\draw (0,0) node [below left] {\includegraphics[width=0.45\textwidth]{Winand1992_diagram.png}};
		\draw (a.north east) node [below right] {\includegraphics[width=0.45\textwidth]{Anders2009_SZM_.png}};
	\end{tikzpicture}
