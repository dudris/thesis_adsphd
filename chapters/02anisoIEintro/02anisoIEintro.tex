...
In the following, only 2D cross section is discussed. See the Figure~\ref{REF} for illustration.

\begin{figure}
	\centering
	\includegraphics[width=0.6\textwidth]{mariaux2011_Winterbottom_construction.png}
\end{figure}
