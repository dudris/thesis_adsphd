...
Two different types of singularities may occur in Wulff shapes, which must be treated in a specific way: corners and facets~\cite{Kobyashi2001, Fleck2011}. 
...
\end{equation}
The following equation is a necessary condition for the triple junction stability as function of its configuration (i.e. the angles under which the interfaces meet along the triple line). It is called Herring relations and was published in 1951~\cite{Herring1999}
...
\end{equation}
where the subscripts now denote interfaces numbered from 1 to 3. 
