...
Below, the different basic cases are introduced, starting with homogeneous nucleation with isotropic interface energy, then heterogeneous nucleation with isotropic interface energy and subsequently the anisotropic interface energy is introduced. The basis of the analysis rests always on the analysis of the total system energy change upon insertion of the nucleus. The total energy change depends on the exact values of the bulk and interface energy contributions in the respective cases. 
