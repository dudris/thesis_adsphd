...
% These equilibrium shapes are called Wulff shapes when the interface energy is anisotropic. Equilibrium shape of interface with isotropic interface energy is a sphere.
    \subsection{Nucleation with isotropic interface energy}
        ...
        \begin{figure}
            \centering
            \includegraphics[page=4,width=0.0.45\textwidth]{sketches_intro.pdf}
            %
            \includegraphics[page=3,width=0.0.45\textwidth]{sketches_intro.pdf}
        ...
        \begin{figure}
            \centering
            \includegraphics[page=2,width=0.0.45\textwidth]{sketches_intro.pdf}
    ...
    \begin{figure}
        \centering
        \includegraphics[page=7,width=0.0.45\textwidth]{sketches_intro.pdf}
