...
\section{Validations}
	...
	\begin{figure}
		...
		\end{tikzpicture}
		\caption[Sketch - tilted line validation of the general NBC controlling interface inclination on the domain boundary]{Validation of the general NBC for control of the inclination angle at the boundary - tilted line simulations (isotropic interface energy). In the simulations with inclination-dependent interface energy there was $\vartheta_{init}=\vartheta$}
