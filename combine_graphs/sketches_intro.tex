...
\begin{tikzpicture}
    ...
    \begin{axis}[
        ...
        ymin=-1.2,
        ymax=1.7,
        legend entries={area,line,$\Delta G$},
        ...
        \draw[blue] (axis cs:0.25,-1.4*\barr) node [right] {$\approx -R^2$};
        \draw[red] (axis cs:0.25,1.8*\barr) node [right] {$\approx R$};
...
\begin{tikzpicture}
    ...
    \begin{axis}[
        ...
        ymin=-0.8,
        ymax=1.7,
        legend entries={bulk,surface,$\Delta G$},
        ...
        \draw[blue] (axis cs:0.17,-\barr) node [right] {$\approx -R^3$};
        \draw[red] (axis cs:1.15,3*\barr) node [right] {$\approx R^2$};
